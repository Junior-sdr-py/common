class Cat:
    ...
    * Implement get_average_speed and return average_speed
    ...
    def eat(self, product):
        _eats = {'fodder': 10, 'apple': 5, 'milk': 2}
        if product in _eats.keys():
            self._increase_saturation_level(_eats.get(product))
...
class Cheetah(Cat):
    ...
    * Redefine method _set_average_speed
    ...
    def eat(self, product):
        _eats = {'gazelle': 30, 'rabbit': 15}
        if product in _eats.keys():
            self._increase_saturation_level(_eats[product])
...
class Wall:
    ...
    * Implement method number_of_rolls_of_wallpaper which receives such parameters: roll_width_m, roll_length_m
    ...
    def number_of_rolls_of_wallpaper(self, roll_width_m, roll_length_m):
        count_of_lines_in_rol = round(roll_length_m / self.height)
        count_of_lines = round(self.width / roll_width_m)
        return round(count_of_lines / count_of_lines_in_rol)
...
class House:
    ...
    * Implement method get_room_square that returns the square of our room
    ...
    def update_metal_price(self, update_metal_price):
        return self.__door.update_metal_price(update_metal_price)
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        if roll_length_m and roll_width_m:
